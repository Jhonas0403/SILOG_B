-- ============================================================
-- V10: Create sale_details table
--
-- Depends on: sales (V9), product_variants (V6), users (V1)
--
-- ON DELETE CASCADE on sale_id:
--   If a sale is deleted, its details are deleted automatically.
...
COMMENT ON TABLE sale_details IS 'Line items of a sale (one row per product variant sold)';
